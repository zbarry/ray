...
def move_file(filename, build_ext: _build_ext.build_ext):
    # TODO(rkn): This feels very brittle. It may not handle all cases. See
    # https://github.com/apache/arrow/blob/master/python/setup.py for an
    # example.
    source = filename
    destination = os.path.join(build_ext.build_lib, filename)
...
def install_files(build_ext: _build_ext.build_ext):
...
class nobuild_ext(_build_ext.build_ext):
    def run(self):
        install_files(self)
